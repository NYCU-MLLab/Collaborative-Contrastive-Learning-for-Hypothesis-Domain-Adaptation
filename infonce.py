...
def info_nce(query, positive_key, negative_keys=None, temperature=0.07, reduction='mean', negative_mode='unpaired'):
    ...
    if negative_keys is not None:
        ...
        #positive_logit = torch.sum(F.cosine_similarity(query,positive_key), dim=1, keepdim=True)
